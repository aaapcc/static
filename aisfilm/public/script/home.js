        ...
        'Init':function(){
            ...
            if(MAC.Cookie.Get('user_id') !=undefined && MAC.Cookie.Get('user_id')!=''){
                ...
                if($('.mac_user').length >0) {
                    ...
                    var html = '<div class="mac_user_wrap"><div class="mac_user_box dropbox user">';
                    html += '<div class="user_list_box"><div class="user_list"><a class="mac_user_n" href="javascript:;">'+MAC.User.UserName+'</a><a class="mac_user_g" href="javascript:;">' + GName + '</a><a href="' + url + '" target="_blank"><i class="iconfont"></i>个人中心</a><a href="' + urlfavs + '" target="_blank"><i class="iconfont"></i>我的收藏</a><a href="javascript:;" onclick="MAC.User.Logout();" target="_self" class="tc">退出账号</a></div></div></div>'
